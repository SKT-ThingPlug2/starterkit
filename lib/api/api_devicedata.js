...
module.exports = function(baseObj){
    ...
    obj.sensorNodeEntity.forEach(function(entity){
        // var exists = fs.existsSync('./lib/sensors/'+entity+'.js');
        // if(!exists){
        //     console.log(colors.red("not found sensor file : " + entity));
        //     process.exit(1);
        // }
...
var telemetries = function(){
    ...
    obj.sensorNodeEntity.forEach(function(entity){
            var telemetry = {};
            descriptor[entity].deviceData.telemetries.forEach(function(value){
...
var attributes = function(){
    ...
    obj.sensorNodeEntity.forEach(function(entity){
            var attribute = {};
            descriptor[entity].deviceData.attributes.forEach(function(value){
