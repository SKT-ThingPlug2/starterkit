...
module.exports = function(app, configObject){
    ...
    if(!baseObject.dataRate) baseObject.dataRate = 60;
...
process.addListener('psKill', function(message){
    psKill();
});